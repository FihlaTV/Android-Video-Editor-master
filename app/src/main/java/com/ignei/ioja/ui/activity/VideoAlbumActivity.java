...
import com.ignei.ioja.SpaceItem;
import com.ignei.ioja.adapter.VideoGridAdapter;
import com.ignei.ioja.base.BaseActivity;
import com.ignei.ioja.model.LocalVideoModel;
...
//        mRecyclerView.addItemDecoration(new DividerGridItemDecoration(this));
        ...
        int space = 8;
        mRecyclerView.addItemDecoration(new SpaceItem(space));
        mAdapter.setOnItemClickListener(this);
        BackBtn.setOnClickListener(View->{
            MainActivity.startActivity(VideoAlbumActivity.this);
            finish();
        });
    }
