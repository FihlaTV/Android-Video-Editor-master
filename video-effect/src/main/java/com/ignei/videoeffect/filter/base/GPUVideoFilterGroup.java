...
package com.ignei.videoeffect.filter.base;


import android.annotation.SuppressLint;
import android.opengl.GLES20;
import com.ignei.videoeffect.Rotation;
import com.ignei.videoeffect.utils.TextureRotationUtil;
...
/**
 * Resembles a filter_btn that consists of multiple filters applied after each
 * other.
 */
public class GPUVideoFilterGroup extends GPUVideoFilter {
     ...
     *
     * @param filters the filters which represent this filter_btn
     */
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.filter_btn.GPUVideoFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.filter_btn.GPUVideoFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * jp.co.cyberagent.android.gpuimage.filter_btn.GPUVideoFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.filter_btn.GPUVideoFilter#onDraw(int,
