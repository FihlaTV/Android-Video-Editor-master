...
import com.ignei.videoeffect.render.VideoGlRender;
...
public class GlVideoView extends GLSurfaceView {
    ...
    /**
     * Set the filter_btn to be applied on the image.
     *
    ...
    /**
     * Get the current applied filter_btn.
     *
     * @return the current filter_btn
     */
